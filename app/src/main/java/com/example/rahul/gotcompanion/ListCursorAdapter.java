...
public class ListCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        String imgLink = cursor.getString(cursor.getColumnIndex(ProfileContract.ProfileEntry.IMAGELINK));

        name.setText(nameText);
        Picasso.get().load(imgLink).placeholder(R.drawable.no_image).into(image);
